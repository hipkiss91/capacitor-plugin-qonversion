...
| Param         | Type                                                                                              |
| ------------- | ------------------------------------------------------------------------------------------------- |
| **`options`** | <code>{ key: <a href="#string">String</a>; observerMode: <a href="#boolean">Boolean</a>; }</code> |

**Returns:** <code>Promise&lt;<a href="#objectdata">objectData</a>&gt;</code>
...
| Param         | Type                                                                                                                                                                                   |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`options`** | <code>{ sourceKey: <a href="#string">String</a>; source: <a href="#string">String</a>; sdkVersionKey: <a href="#string">String</a>; sdkVersion: <a href="#string">String</a>; }</code> |
...
| Param         | Type                                 |
| ------------- | ------------------------------------ |
| **`options`** | <code>{ products: String[]; }</code> |
...
| Param         | Type                                                      |
| ------------- | --------------------------------------------------------- |
| **`options`** | <code>{ productId: <a href="#string">String</a>; }</code> |
